...
/*
Define Asset Path */
def assetpath = '/content/dam'

def predicates = [path: assetpath, type: "dam:Asset",  "orderby.index": "true", "orderby.sort": "desc"]
...
def getAllReferences(assetpath) {
    ...
    def statement = "/jcr:root" + "/content//*" + "[jcr:contains(., '"+assetpath+"')]"
